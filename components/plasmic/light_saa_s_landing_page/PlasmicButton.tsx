...
import sty from "./PlasmicButton.module.css"; // plasmic-import: TbNv2TMmHPSn/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__bl9Tj)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__dNNaj)}
                role={"img"}
              />
            ),
